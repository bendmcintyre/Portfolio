...
const Contact = () => {
  ...
  return (
    <div className={`${styles.container} ${isLoaded ? styles.visible : ''} ${isSubmitted ? styles.hidden : ''}`}>
      {!isSubmitted ? (
        <form ref={formRef} onSubmit={handleSubmit} className={styles.fadeInOut}>
        ...
        <p className={`${styles['success-message']} ${styles.visible} ${styles.fadeInOut}`}>
